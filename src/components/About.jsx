...
const About = () => {
  return (
    <div className="lg:flex p-3 lg:items-center lg:justify-center lg:p-10">
            ...
            <div className="aboutMe lg:flex lg:justify-around text-center lg:text-start lg:items-center lg:mb-6">
                ...
                <div className="myDetails  pb-4 lg:pb-0">
                    <p className="text-lg pb-2">
                        <span className="font-bold text-[#f4f4f4]">Name : </span>
                        Ashish Jha
                    </p>
                    <p className="text-lg pb-2">
                        <span className="font-bold text-[#f4f4f4]">Profile : </span>
                        Full Stack Web Developer
                    </p>
                    <p className="text-lg pb-2">
                        <span className="font-bold text-[#f4f4f4]">Email : </span>
                        ashjha2002@gmail.com
                    </p>
                </div>
            </div>
            <div className="mySkills lg:p-5">
                <h1 className="skillsHead text-3xl font-bold text-[#f4f4f4]">Skills</h1>
                <div className="skill pt-4 pb-4">
                    ...
                    <div className="skillView pt-1">
                        <div className="fullLine bg-slate-600 rounded-xl">
                            <div className="skillLine bg-gray-200 p-2 w-[75%] rounded-xl"></div>
                        </div>
                    </div>
                </div>
                <div className="skill pb-4">
                    ...
                    <div className="skillView pt-1">
                        <div className="fullLine bg-slate-600 rounded-xl">
                            <div className="skillLine bg-gray-200 p-2 w-[82%] rounded-xl"></div>
                        </div>
                    </div>
                </div>
                <div className="skill pb-4">
                    ...
                    <div className="skillView pt-1">
                        <div className="fullLine bg-slate-600 rounded-xl">
                            <div className="skillLine bg-gray-200 p-2 w-[55%] rounded-xl"></div>
                        </div>
                    </div>
                </div>
                <div className="skill pb-4">
                    ...
                    <div className="skillView pt-1">
                        <div className="fullLine bg-slate-600 rounded-xl">
                            <div className="skillLine bg-gray-200 p-2 w-[65%] rounded-xl"></div>
                        </div>
                    </div>
                </div>
                <div className="skill pb-4">
                    ...
                    <div className="skillView pt-1">
                        <div className="fullLine bg-slate-600 rounded-xl">
                            <div className="skillLine bg-gray-200 p-2 w-[90%] rounded-xl"></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div className="about lg:w-[50%] lg:p-5">
            <h1 className="text-5xl pb-5 font-bold text-[#f4f4f4]">About Me</h1>
