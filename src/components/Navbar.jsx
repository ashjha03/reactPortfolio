const Navbar = () => {
  return (
    <nav
      ...
      className="lg:flex py-5 px-2 md:px-10 justify-between items-center w-full overflow-scroll"
    >
      ...
      <div className="navLinks">
        ...
        <a className="pr-5" href="#services">Services</a>
        <a className="pr-5" href="#projects">Projects</a>
